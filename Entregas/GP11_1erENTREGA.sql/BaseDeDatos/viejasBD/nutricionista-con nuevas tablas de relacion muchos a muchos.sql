...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2024 a las 00:11:12
...
CREATE TABLE `menudiario` (
  `idMenuDiario` int(11) NOT NULL,
  `Nombre del Menu` varchar(100) NOT NULL,
  `dia` int(11) NOT NULL,
...
--
ALTER TABLE `alimento_keyword`
  ADD CONSTRAINT `alimento_keyword_ibfk_1` FOREIGN KEY (`idAlimento`) REFERENCES `alimento` (`idAlimento`),
  ADD CONSTRAINT `alimento_keyword_ibfk_2` FOREIGN KEY (`idKeyword`) REFERENCES `keywords` (`idKeyword`);
